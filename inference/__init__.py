...
def __getattr__(name: str) -> Any:
	...
	if name == "WhisperTranscriberHF":
		from inference.whisper_service import WhisperTranscriberHF as _WhisperTranscriberHF

		return _WhisperTranscriberHF
	if name == "WhisperTranscription":
		from inference.whisper_service import WhisperTranscription as _WhisperTranscription
